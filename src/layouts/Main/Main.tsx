...
const Main = () => {
  ...
  const titleOpacity = useTransform(mainScrollY, [0.3, 0.5], [1, 0]);

  const backgroundY = useParallax(mainScrollY, 500);
  const ticketY = useParallax(mainScrollY, '8vw');

  const guideOpacity_1 = useTransform(mainScrollY, [0, 0.2], [1, 0]);
  const guideOpacity_2 = useTransform(mainScrollY, [0.2, 0.4], [0, 1]);
